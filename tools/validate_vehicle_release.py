...
for name,(glb,blend,preview) in areas.items():
 ...
 l2=100 if all((ROOT/p).is_file() for p in ['technical_model/2004_explorer_sport_trac_4wd/README.md','app/src/main/assets/models/README.md','docs/VEHICLE_VERIFICATION_MANIFEST.md','docs/2004_SPORT_TRAC_CHARM_WORKSHOP.md','docs/SPORT_TRAC_OG_SCALE.md']) else 80
